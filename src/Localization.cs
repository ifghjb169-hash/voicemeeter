            ...
            {
                {
                    "zh", new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
                    {
                        ...
                        {"volume.none", "没有可调节音量的物理设备或主 Voicemeeter 设备"},
                        {"volume.unavailable", "不可用"},
                        {"status.systemRead", "已读取 {0} 个输出设备、{1} 个输入设备。"},
                        {"status.systemReadFailed", "读取系统声音设备失败：{0}"},
                        {"status.startupDefaultsApplied", "未保存过用户选择，已按默认策略设置：{0}"},
                        {"status.startupDefaultsMissing", "未保存过用户选择，但没有找到完整的 Voicemeeter VAIO 默认设备：{0}"},
                        {"status.vmDefaultOutput", "默认输出 -> {0}"},
                        {"status.vmDefaultInput", "默认输入 -> {0}"},
                        {"status.vmDefaultOutputMissing", "没有找到 VoiceMeeter Input 默认输出设备"},
                        {"status.vmDefaultInputMissing", "没有找到 VoiceMeeter Output 默认输入设备"},
                ...
                },
                {
                    "en", new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
                    {
                        ...
                        {"volume.none", "No physical or main Voicemeeter device with adjustable volume"},
                        ...
                        {"status.startupDefaultsApplied", "No saved user choice; applied default route: {0}"},
                        {"status.startupDefaultsMissing", "No saved user choice, but the full Voicemeeter VAIO default devices were not found: {0}"},
                        ...
                        {"status.vmDefaultInputMissing", "VoiceMeeter Output default input device was not found"},
                ...
                },
                {
                    "pt", new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
                    {
                        ...
                        {"volume.none", "Nenhum dispositivo físico ou Voicemeeter principal com volume ajustável"},
                        ...
                        {"status.startupDefaultsApplied", "Nenhuma escolha salva; rota padrão aplicada: {0}"},
                        {"status.startupDefaultsMissing", "Nenhuma escolha salva, mas os dispositivos padrão Voicemeeter VAIO completos não foram encontrados: {0}"},
                        ...
                        {"status.vmDefaultInputMissing", "Dispositivo de entrada padrão VoiceMeeter Output não encontrado"},
                ...
                },
                {
                    "es", new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
                    {
                        ...
                        {"volume.none", "No hay dispositivos físicos o Voicemeeter principal con volumen ajustable"},
                        ...
                        {"status.startupDefaultsApplied", "No había una selección guardada; se aplicó la ruta predeterminada: {0}"},
                        {"status.startupDefaultsMissing", "No había una selección guardada, pero no se encontraron todos los dispositivos predeterminados de Voicemeeter VAIO: {0}"},
                        ...
                        {"status.vmDefaultInputMissing", "No se encontró el dispositivo de entrada predeterminado VoiceMeeter Output"},
